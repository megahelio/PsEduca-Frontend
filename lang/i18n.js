...
const locales = {
  ...
  es: {
    ...
    catalog: {
      ...
      data: "Datos",
      authors: "Autores",
      yearPublished: "Año publicación",
      ageRange: "Rango de edad",
      duration: "Duración",
      areaApplication: "Área / Aplicación",
      ...
      files: "Archivos",
      title: "Catálogo",
      createCatalog: "Crear recurso",
      access: "Acceso",
      type: "Tipo",
      save: "Guardar",
      delete: "Eliminar",
      titleDetail: "Información del recurso",
      edadAnhoMin: "Años mínimos",
      edadAnhoMax: "Años máximos",
      edadMesMin: "Meses mínimos",
      edadMesMax: "Meses máximos",
  ...
  en: {
    ...
    catalog: {
      ...
      data: "Data",
      authors: "Authors",
      yearPublished: "Year publication",
      ageRange: "Age range",
      duration: "Duration",
      areaApplication: "Area / Application",
      ...
      tags: "Tags",
      title: "Catalog",
      createCatalog: "Create resource",
      access: "Access",
      type: "Type",
      save: "Save",
      delete: "Delete",
      titleDetail: "Resource detail",
      edadAnhoMin: "Minimum years",
      edadAnhoMax: "Maximum years",
      edadMesMin: "Minimum months",
      edadMesMax: "Maximum months",
  ...
  gl: {
    ...
    catalog: {
      ...
      data: "Datos",
      authors: "Autores",
      yearPublished: "Ano publicación",
      ageRange: "Rango de idade",
      duration: "Duración",
      areaApplication: "Área / Aplicación",
      typeFormat: "Tipo / Formato",
      description: "Descrición",
      ...
      save: "Gardar",
      delete: "Eliminar",
      titleDetail: "Información do recurso",
      edadAnhoMin: "Anos mínimos",
      edadAnhoMax: "Anos máximos",
      edadMesMin: "Meses mínimos",
      edadMesMax: "Meses máximos",
      relatedDocuments: "Documentos relacionados",
      file: "Arquivo",
